...
public class Language {
  ...
  /// </summary>
  public IReadOnlyList<BaseGrammarDefinition> TokenDefinitions => Tokenizer.GrammarDefinitions;
  ...
  public Language(params BaseGrammarDefinition[] grammarDefinitions) {
