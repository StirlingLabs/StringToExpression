...
public static class ExpressionConversions {
  ...
  private static readonly Dictionary<Type, Type[]> ImplicitConversions = new() {
    ...
    { typeof(int), new[] { typeof(int), typeof(long), typeof(double) } },
    { typeof(uint), new[] { typeof(uint), typeof(long), typeof(ulong), typeof(double) } },
    { typeof(long), new[] { typeof(long) } }, {
      typeof(char),
      new[] {
        typeof(char), typeof(ushort), typeof(int), typeof(uint), typeof(long), typeof(ulong),
        typeof(float), typeof(double),
      }
    },
    { typeof(float), new[] { typeof(float), typeof(double) } },
  ...
  /// <summary>
  /// Tries a type that both passed types can safely convert to.
  /// </summary>
