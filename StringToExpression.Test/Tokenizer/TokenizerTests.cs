...
public class TokenizerTests {
  ...
  public void When_unknown_token_should_throw() {
    ...
    var exception = Assert.Throws<GrammarUnknownException>(() => language.Tokenizer.Tokenize("1 + 2 * 3 - 5").EnumerateOnly())!;
  ...
  public void When_invalid_definition_name_should_throw() {
    var exception = Assert.Throws<GrammarDefinitionInvalidNameException>(() => TestUtil.Discard(() => new GrammarDefinition("I-am-not a valid name", @"B")))!;
