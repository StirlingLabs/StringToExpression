...
public class LinqToQuerystringTestDataFixture {
  ...
  public LinqToQuerystringTestDataFixture() {
    ...
    FunctionConcreteCollection = new List<ConcreteClass> {
      InstanceBuilders.BuildConcrete("Saturday", 1, new(2001, 01, 01, 01, 05, 00), true),
      InstanceBuilders.BuildConcrete("Satnav", 2, new(2002, 01, 02, 06, 10, 10), false),
      InstanceBuilders.BuildConcrete("Saturnalia", 3, new(2003, 02, 02, 10, 10, 20), true),
      InstanceBuilders.BuildConcrete("Saturn", 4, new(2004, 04, 06, 10, 20, 30), true),
      InstanceBuilders.BuildConcrete("Monday", 5, new(2005, 06, 21, 13, 20, 40), true),
      InstanceBuilders.BuildConcrete("Tuesday", 5, new(2005, 06, 30, 20, 20, 50), true),
      InstanceBuilders.BuildConcrete("Burns", 5, new(2005, 10, 31, 23, 35, 50), true)
    }.AsQueryable();

    EdgeCaseCollection = new List<ConcreteClass> {
      InstanceBuilders.BuildConcrete("Apple\\Bob", 1, new(2002, 01, 01), true),
      InstanceBuilders.BuildConcrete("Apple\bBob", 1, new(2002, 01, 01), true),
      InstanceBuilders.BuildConcrete("Apple\tBob", 1, new(2002, 01, 01), true),
      InstanceBuilders.BuildConcrete("Apple\nBob", 1, new(2002, 01, 01), true),
      InstanceBuilders.BuildConcrete("Apple\fBob", 1, new(2002, 01, 01), true),
      InstanceBuilders.BuildConcrete("Apple\rBob", 1, new(2002, 01, 01), true),
      InstanceBuilders.BuildConcrete("Apple\"Bob", 1, new(2002, 01, 01), true),
      InstanceBuilders.BuildConcrete("Apple'Bob", 1, new(2002, 01, 01), true),
      InstanceBuilders.BuildConcrete("x y & z", 1, new(2002, 01, 01), true),
    }.AsQueryable();

    ComplexCollection = new List<ComplexClass> {
      new() { Title = "Charles", Concrete = InstanceBuilders.BuildConcrete("Apple", 5, new(2005, 01, 01), true) },
      new() { Title = "Andrew", Concrete = InstanceBuilders.BuildConcrete("Custard", 3, new(2007, 01, 01), true) },
      new() { Title = "David", Concrete = InstanceBuilders.BuildConcrete("Banana", 2, new(2003, 01, 01), false) },
      new() { Title = "Edward", Concrete = InstanceBuilders.BuildConcrete("Eggs", 1, new(2000, 01, 01), true) },
      new() { Title = "Boris", Concrete = InstanceBuilders.BuildConcrete("Dogfood", 4, new(2009, 01, 01), false) }
    }.AsQueryable();
  ...
  public static class InstanceBuilders {
    ...
    public static ConcreteClass BuildConcrete(string name, int age, DateTime date, bool complete) => new() { Name = name, Date = date, Age = age, Complete = complete };
    ...
    public static NullableClass BuildNull() => new();
